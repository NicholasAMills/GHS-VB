...
Private Sub mnuEditFind_Click()
    ...
    intFoundPos = InStr(1, txtFile.Text, strSearchFor, 1)
    If intFoundPos = 0 Then
        intRetVal = MsgBox(conMsg, conBtns, "Find")
    Else
        txtFile.SelStart = intFoundPos - 1
        txtFile.SelLength = Len(strSearchFor)
    End If
...
Private Sub mnuFineNext_Click()
    ...
    intBegSearch = txtFile.SelStart + 2
    intFoundPos = InStr(intBegSearch, txtFile.Text, strSearchFor, 1)
    If intFoundPos = 0 Then
